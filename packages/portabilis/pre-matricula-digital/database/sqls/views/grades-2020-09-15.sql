...
SELECT serie.cod_serie     AS id,
       ...
       (date_part('year', CURRENT_DATE) - serie.idade_inicial) || to_char(instituicao.data_base_matricula, '-mm-dd') AS start_birth,
       (date_part('year', CURRENT_DATE) - serie.idade_final) || to_char(instituicao.data_base_matricula, '-mm-dd') AS end_birth,
