...
SELECT exporter_preregistration.protocol,
    ...
    instituicao.ref_sigla_uf AS institution_federal_unit,
       ...
       exporter_preregistration.student_date_of_birth,
       exporter_preregistration.responsible_phone,
       exporter_preregistration.responsible_name as student_responsible_name,
       exporter_preregistration.position
