...
class CreateTimelineResponsibleListener extends TranslateAttributesAbstract
{
    public function handle(PreRegistrationResponsibleUpdatedEvent $event): void
    {
        $this->formatEventAttributes($event);

        TimelineService::create(
            type: 'preregistration-student-responsible-updated',
