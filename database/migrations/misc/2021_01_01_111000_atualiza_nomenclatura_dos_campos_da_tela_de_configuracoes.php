        ...
        DB::unprepared('
            ...
            SET description = (
                CASE key
                    ...
                    WHEN \'legacy.apis.access_key\' THEN \'Chave de acesso ao Yazo Educacional\'
                    WHEN \'legacy.apis.secret_key\' THEN \'Chave secreta do Yazo Educacional\'
                    ...
                    WHEN \'legacy.app.locale.country\' THEN \'País do cliente (código do Yazo Educacional)\'
