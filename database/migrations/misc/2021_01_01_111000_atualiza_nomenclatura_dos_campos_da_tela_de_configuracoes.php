        ...
        DB::unprepared('
            ...
            SET description = (
                CASE key
                    ...
                    WHEN \'legacy.apis.access_key\' THEN \'Chave de acesso ao SIDUC\'
                    WHEN \'legacy.apis.secret_key\' THEN \'Chave secreta do SIDUC\'
                    ...
                    WHEN \'legacy.app.locale.country\' THEN \'País do cliente (código do SIDUC)\'
