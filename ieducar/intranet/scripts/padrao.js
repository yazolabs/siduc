...
/**
 * @TODO Remover função, chamadas no sistema SIDUC comentadas (código nunca invocado).
...
/**
 * @TODO Remover função, chamadas no sistema SIDUC são em código legado em
 ...
 *   presentes no sistema SIDUC. Ver: $ egrep -rn 'excluirSumit[ ]{0,3}\(' intranet/
 */
