...
/**
 * @TODO Remover função, chamadas no sistema Educacional comentadas (código nunca invocado).
...
/**
 * @TODO Remover função, chamadas no sistema Educacional são em código legado em
 ...
 *   presentes no sistema Educacional. Ver: $ egrep -rn 'excluirSumit[ ]{0,3}\(' intranet/
 */
